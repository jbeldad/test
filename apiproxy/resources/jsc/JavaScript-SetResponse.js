...
if (requestPath == "/mock/v1/bank/account") {
    ...
    switch(accountId) {
        ...
        case 1002:
            ...
            break;
        case 1003:
            response = '{"id":1003,"accountName":"JUAN DELA CRUZ","accountType":"Savings","balance":543.21}';
            break;
        case 1004:
        ...
        switch(accountId) {
            ...
            case 1002:
                ...
                break;
            case 1003:
                response = '{"accountId":1003,"accountName":"JUAN DELA CRUZ","accountType":"Savings","accountBalance":543.21,"creditCardNo":1111000022220003,"creditLimit":30000.0,"creditCardBalance":333.33,"insuranceId":100003,"insuranceType":"Life","insuranceBalance":333.33}';
                break;
            case 1004:
